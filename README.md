...
the [TS template](https://vitejs.dev/guide/features.html#typescript)
for information on how to integrate TypeScript and [`typescript-eslint`](https://typescript-eslint.io/)
in your project.